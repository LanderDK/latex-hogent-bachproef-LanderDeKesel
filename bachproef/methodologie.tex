...
\section{\gls{auth} aanbieders vergelijken}%
...
\begin{lstlisting}[language=bash, caption=Oathkeeper Docker Image downloaden]
...
\begin{lstlisting}[language=bash, caption=Oathkeeper Configuratie]
  listen:
    host:
authenticators:
  noop:
...
\begin{lstlisting}[language=bash, caption=Oathkeeper Regels]
[
  {
    "id": "example-rule",
    "upstream": {
...
\subsection{Verbeterpunten voor bestaande systemen}%
